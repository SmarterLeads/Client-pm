...
CREATE TABLE pm.monthly_financials (
  ...
  cdn_sales_cents integer NOT NULL DEFAULT 0,
  cdn_exp_cents   integer NOT NULL DEFAULT 0,
  us_sales_cents  integer NOT NULL DEFAULT 0,
  us_exp_cents    integer NOT NULL DEFAULT 0,
