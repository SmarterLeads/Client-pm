-- Preferred contact method on client contacts.
...
BEGIN
  ...
  VALUES (
    ...
    NULLIF(p_contact->>'preferred_contact_method', '')
  )
...
BEGIN
  ...
  SET
    ...
    preferred_contact_method = CASE
      WHEN p_payload ? 'preferred_contact_method'
      THEN NULLIF(p_payload->>'preferred_contact_method', '')
