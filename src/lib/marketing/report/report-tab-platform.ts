...
export function buildChartDataForRows(
...
): import("@/components/marketing/report/performance-line-chart").ReportSeriesPoint[] {
  ...
  const data: import("@/components/marketing/report/performance-line-chart").ReportSeriesPoint[] = [];
